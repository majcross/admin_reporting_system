                                        ...
                                        <div class="table-wrapper">
                                                ...
                                                <table class="table new_table">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $branch = $_POST['branch'];
                                                            $users = User::find_all_exit_branch($branch);
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="do_exit.php?id=<?php echo $staff->user_id ?>" class="btn btn-success">Restore</button> </a></td>
                                                            <!-- <?php $_SESSION['branch_name'] = $staff->branch; ?> -->
                                                        </tr>
