...
<body>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="create_staff.php"><i class="fa fa-fw fa-bar-chart-o"></i> Create Staff</a>
                    </li>
                    <li>
                        <a href="base_line.php"><i class="fa fa-fw fa-table"></i> Create Base line</a>
                    </li>
                    <li>
                                                ...
                                                <table class="table new_table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="index.php?id=<?php echo $staff->user_id ?>" class="btn">View Base Line</button> </a></td>
  ...
  <footer>
            <div class="container row">
                <div class="col-lg-12">
                    <p style="text-align: center; font-family: italic; color: #3f617e;">Design BY ADEYEMO MICHAEL &copy;  2023</p>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
