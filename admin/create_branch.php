...
<?php require_once('server/lang.php');
      require_once($xyz1);
        ...
        if (isset($_POST['create_branch'])) {
            ...
            // Method to check branch
            $branch_found = User::verify_branch($branch);
            if (!$branch_found) {

           
            $new_staff->branch    = $branch;

            $new_staff->create_branch();

            $the_message = "Branch successful create";
            // $branch = "";
                
            }else{
                $the_message = "Branch exist";
            }
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7 container well">
                                <form id="login-id" action="" method="post">
    
                                    <div class="form-group">
                                        <h4 class="bg-danger"><?php echo $the_message; ?></h4>
                                        <label for="Branch">Branch</label>
                                        <input type="text" class="form-control" name="branch" value="<?php echo htmlentities($branch); ?>"  required>

                                    </div>


                                    <div class="form-group">
                                    <input type="submit" name="create_branch" value="Submit" class="btn btn-primary">
